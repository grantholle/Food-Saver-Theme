...
// browserfiy solution
// ========
return;  require('./lib/polyfill.object.keys');  require('./lib/polyfill.array.forEach');  require('./modules/placeholder-fix');  require('./modules/ie9-animations');  require('./modules/internet-explorer');  require('./modules/site-loader');  require('./modules/fastclick');  require('./modules/sidebar');  require('./modules/header');  require('./modules/scroll-to-top');  require('./modules/live-stream');  require('./modules/time-lapse');  require('./modules/contest-form');  require('./modules/sticky-green-bar');  require('./modules/event-cards');  require('./modules/clock'); 